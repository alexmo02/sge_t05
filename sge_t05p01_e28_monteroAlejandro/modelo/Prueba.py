...
class Prueba: 
    def cargarSocios(club : Club):
        ...
        '22222222B' : Socio (club.getUsuario('22222222B'), 'Pepito López', 'c/direccion2', 666777999, "pepito@gmail.com", [Bicicleta('30/05/2020', "Canondale", "Modelo1", "Montaña", "Negro", 5, 27, 600, [Reparacion('30/05/2021', 120, "Cambio de manillar", "delantera")]), Bicicleta('26/06/2020', "Trek", "Modelo2", "Carretera", "Azul", 6, 29, 700, [Reparacion('30/05/2021', 120, "Cambio de manillar", "delantera")])]), '33333333C' : Socio (club.getUsuario('33333333C'), 'Laura Gómez', 'c/direccion2', 666777999, "pepito@gmail.com", [])})
    ...
    def cargarControlCuotas(club : Club):
        datos_año=({'11111111A' : [2022, '11111111A', club.getUsuario('11111111A')._corriente_pago, 15, 0, "27-01-2022" ],
